...
def writeHTTPMetaData(httpMessageListFinal, db_connection):
    ...
    try:
        insertSql = "INSERT INTO HTTP (packageName, srcAddr, srcPort, dstAddr, dstPort, host, URL, requestTime, responseTime, requestHeaders, requestBody, responseHeaders, responseBody, protocol, method, contentType, four_tuple_hash) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
