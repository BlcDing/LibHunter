        ...
        while True:
            ...
            if line != "\n":
                ...
                if line_split_list[6] == "r0capture.py:168":
                    ...
                    continue
                elif line.split(" ")[6] == "r0capture.py:177":
...
if __name__ == '__main__':
    stack_file_path_all = "../stack_phone2/"
    stack_file_path_list = os.listdir(stack_file_path_all)
    print(len(stack_file_path_list))


    for stack_file_path in stack_file_path_list:
        stack_file_path = stack_file_path_all + stack_file_path
        stack_result_file_path = stack_file_path + "_result"
                ...
                while True:
                    ...
                    if stack_begin is True:
                        if line != "\n":
                            ...
                            if line_split_list2.__len__() > 6 and line_split_list2[6] == "r0capture.py:177":
